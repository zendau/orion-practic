...
<html lang="ru">
    <head>
        ...
        <base href="https://orion-temp.herokuapp.com/">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <?
                ...
                if(isset($_POST['btn_gps'])||isset($_POST['gps_search'])){
                    //Кисель
                    $_GET['page']='8';

                    $SESSION['folder'] = $POST['gps_select'];
...
.r4{
    ...
    .gps_select:hover::before {
        color: rgba(255, 255, 255, 0.6);
        background-color: rgba(255, 255, 255, 0.2);
    }

    .gps_select select option {
        padding: 30px;
    }
